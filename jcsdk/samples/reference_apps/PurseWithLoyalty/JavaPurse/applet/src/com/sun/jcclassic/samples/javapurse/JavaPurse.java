 ...
 * <p>
 * See <em>Java Card(TM) Development Kit User's Guide</em> for details.
 * 
 * @author Vadim Temkin
 */
public class JavaPurse extends Applet {
    ...
    private void processCompleteTransaction(APDU apdu) {
        ...
        Util.arrayFillNonAtomic(byteArray8, (short) 0, (short) byteArray8.length, (byte) 0);
        boolean signatureOK = (0 == Util
                .arrayCompare(buffer, ISO7816.OFFSET_CDATA, byteArray8, START, SIGNATURE_LENGTH));
    ...
    private void processCompleteUpdate(APDU apdu) {
        ...
        Util.arrayFillNonAtomic(byteArray8, (short) 0, (short) byteArray8.length, (byte) 0);
        if (0 != Util.arrayCompare(byteArray8, START, buffer, (short) (ISO7816.OFFSET_CDATA + lc - SIGNATURE_LENGTH),
                SIGNATURE_LENGTH)) {
            ISOException.throwIt(SW_WRONG_SIGNATURE);
        }
