...
/**
 * This is the class for all linear variable-length record files, and the base
 * class for linear variable-fixed and cyclic record files.
 * <p>
 * 
 */
...
class ParametersFile {
     ...
     * 
     * @param maxNumRecords
     *            the maximum number of records in this file
     */
    ...
    /**
     * Add (append) a new record to the file. Note that the record reference is
     * stored in the file object. A copy of the record byte array is not made.
     * 
     * @param record
     ...
     * reference to the actual file data, not a copy of the file data. Records
     * are in the order that they were added to the file. Record number is in
     * the range from 1 to the number of records in the file
     * 
     * @param recordNum
