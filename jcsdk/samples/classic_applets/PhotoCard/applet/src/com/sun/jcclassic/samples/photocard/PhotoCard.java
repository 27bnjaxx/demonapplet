...
/**
 * PhotoCard interface Defines methods to be used as interface between photo
 * client and storage smart card
 */
public interface PhotoCard extends Remote {
    ...
    */
    ...
    /**
     * This method requests the smart card to allocate space to store a photo
     ...
     *                thrown if error condition occurs, or invalid parameters
     *                passed.
     */
    public short requestPhotoStorage(short size) throws RemoteException, UserException;

    /**
     * This method loads a series of bytes belonging to the photo into the smart
     * card at the position specified.
     * 
     * @param photoID -
     *            photo slot where to store data
     * @param data -
     *            byte array contaiing binary photo information
     * @param size -
     *            number of bytes being passed into the smart card
     * @param offset -
    ...
    /**
     * This method retrueves a series of bytes belonging to the photo from the
     * smart card at the position specified.
     * 
     * @param photoID -
     *            photo slot where to store data
     * @param size -
     ...
     * @return byte array with binary data from photo stored inside the smart
     *         card
     * @exception UserException -
     *                thrown if error condition occurs, or invalid parameters
     *                passed.
     ...
     *            position inside photo buffer where to access data.
     * @param photoDigest -
     *            msg digest of photo sent by user
     * @param photoOffset -
     *            position inside photoDigest where to access data
     * @return void
     * @exception UserException -
     *                thrown if error condition occurs, or invalid parameters
     *                passed.
