...
package com.sun.jcclassic.samples.signaturemessagerecovery;
...
public class SigMsgRecApplet extends Applet {
    ...
    private static final byte[] RSA_PUB_PRIV_KEY_MOD = { (byte) 0xbe, (byte) 0xdf, (byte) 0xd3, (byte) 0x7a,
    ...
    private static final byte[] RSA_PRIV_KEY_EXP = { (byte) 0x84, (byte) 0x21, (byte) 0xfe, (byte) 0x0b, (byte) 0xa4,
            (byte) 0xca, (byte) 0xf9, (byte) 0x7d, (byte) 0xbc, (byte) 0xfc, (byte) 0x0e, (byte) 0xa9, (byte) 0xbb,
            (byte) 0x7a, (byte) 0xbd, (byte) 0x7d, (byte) 0x65, (byte) 0x40, (byte) 0x2b, (byte) 0x08, (byte) 0xc6,
            (byte) 0xdf, (byte) 0xc9, (byte) 0x4b, (byte) 0x09, (byte) 0x6a, (byte) 0x29, (byte) 0x3b, (byte) 0xc2,
            (byte) 0x42, (byte) 0x88, (byte) 0x23, (byte) 0x44, (byte) 0xaf, (byte) 0x08, (byte) 0x82, (byte) 0x4c,
            (byte) 0xff, (byte) 0x42, (byte) 0xa4, (byte) 0xb8, (byte) 0xd2, (byte) 0xda, (byte) 0xcc, (byte) 0xee,
            (byte) 0xc5, (byte) 0x34, (byte) 0xed, (byte) 0x71, (byte) 0x01, (byte) 0xab, (byte) 0x3b, (byte) 0x76,
            (byte) 0xde, (byte) 0x6c, (byte) 0xa2, (byte) 0xcb, (byte) 0x7c, (byte) 0x38, (byte) 0xb6, (byte) 0x9a,
            (byte) 0x4b, (byte) 0x28, (byte) 0x01 };
    ...
    /**
     * the sigBuff buffer would hold the signature output of the Signature class
     * and an extra 2 bytes for the length of recoverable message sent back to
     * the caller
     */
    byte[] sigBuff;
    short sigLen;
    /**
     * the following state variable has the following value: 0 => recovery has
     * not yet started 1 => signature recovered. Waiting for rest of message
     */
    byte recState;
    ...
    /**
     * For the purposes of this sample, Assumed that all the data to be signed
     * fits into one APDU buffer
     */
    ...
    /**
     * in this case, all the message is inside the signature. We only expect one
     * APDU with signature
     */
    ...
    /**
     * This method is called when there is partial message recovery. The
     * recoverable message inside the signature is consumed by this applet. In
     * this case, the first APDU contains the signature and returns true if
     * recovery successful the second APDU contains the remainder of the message
     * and the return value represents signature verification
     */
