...
/**
 * package AID 0xA0 0x00 0x00 0x00 0x62 0x03 0x01 0x0C 0x07 0x01 applet AID -
 * 0xA0 0x00 0x00 0x00 0x62 0x03 0x01 0x0C 0x07 0x01 0x01
 *
...
public class A extends Applet {
    ...
    public static byte[] BApp1AID = { (byte) 0xA0, (byte) 0x00, (byte) 0x00, (byte) 0x00, (byte) 0x62, (byte) 0x03,
    ...
    short transientDeselectMemUsage;// memory snapshort after making transient
    // usign deselect and initializing
    short transientResetUninitializedMemUsage;// memafter making array but not
    // initializing it
    ...
    /**
     * method sets up the persistent objects by calling setupTrees() and
     * captures the memory available
     */
